                ...
                <div className="p-4 md:p-8 space-y-10">
                    <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                        <div className="space-y-2">
                            ...
                            <p className="text-sm text-muted-foreground max-w-2xl">{store.description || 'Sin descripcion'}</p>
                        ...
                        <div className="flex flex-wrap gap-3">
                            <Button variant="outline" asChild>
                                <Link href="/admin/stores">Cambiar tienda</Link>
                            </Button>
                            <Button asChild>
                                <Link href={`/store/${store.slug}`} target="_blank" rel="noreferrer">Ver tienda</Link>
                            </Button>
                        </div>
                    </div>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Recursos principales de la tienda seleccionada.</CardDescription>
                        </CardHeader>
                        <CardContent>
                    ...
                    <div className="space-y-4">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-sm text-muted-foreground">Todo dentro de esta tienda</span>
                        </div>
