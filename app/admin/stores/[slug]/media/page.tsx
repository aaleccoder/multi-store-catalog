...
export default function MediaPage() {
    ...
    const { data: mediaDetails, isLoading: detailsLoading } = trpc.admin.media.get.useQuery(
        selectedMedia?.id ?? '',
    ...
    const handleUpdateAlt = () => {
        ...
        const newAlt = (document.getElementById('alt-text') as HTMLInputElement).value
            ...
            {detailsLoading || !mediaDetails ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="relative aspect-square bg-muted rounded-lg">
                        <Image src={mediaDetails.url} alt={mediaDetails.alt} fill className="object-contain" />
                    </div>
                    <div>
                            ...
                            >
                                ...
                                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                                    <div className="text-white text-center p-2">
                                        <p className="text-sm font-semibold truncate">{media.alt}</p>
                                    </div>
                                </div>
                            </div>
                        ))}
